...
public class Queen extends Piece {
	...
	private static Collection<KeyPadPosition> possibleMovesFromOrigin = new HashSet<KeyPadPosition>();

	/**
	 * Queens can move diagonally and up and down. It is sufficient, for a 3x4
	 * Keypad just to consider movement of up to three squares across but up to
	 * four squares up as the queen might be on a '0' key and would be able to
	 * move four squares up to a '2'
	 * 
	 * @param key
	 * 
	 * @return all possible positions from (0,0) a queen can move.
	 */
	@Override
